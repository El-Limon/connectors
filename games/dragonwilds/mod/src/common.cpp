...
// ---------------------------------------------------------------------------------------------
// Redaction: the game logs WorldPassword/AdminPassword in cleartext; the plugin must never echo them.
...
std::string Redact(const std::string& s) {
    static const char* kKeys[] = {"WorldPassword", "AdminPassword", "Password"};
    std::string o;
    o.reserve(s.size());
